...
public class CommonServiceImpl implements CommonService {
    ...
    public ResponseResult update(CommonDto dto) {
        ...
        String tableName = dto.getName().name().toLowerCase();
//        //处理自增主键问题
//        CommonWhereDto commonDtoById = new CommonWhereDto();
//        commonDtoById.setFiled("id");
//        commonDtoById.setValue(sequences.sequenceAdChannel().toString());
//        dto.getSets().add(commonDtoById);
        if ("add".equals(model)) {
